...
export function dbConceptToFrontend(
  ...
  return {
    ...
    highlighted: concept.highlighted ?? false,
    designType: concept.design_type ?? 'standard',
    stamps: Array.isArray(concept.stamps) ? concept.stamps : [],
...
export async function POST(request: NextRequest) {
  try {
    ...
    const conceptRow = {
      ...
      design_type: body.designType ?? 'standard',
      stamps: body.stamps ?? [],
      source: body.source ?? '',
